...
const SneakersPage = () => {
  ...
  useEffect(() => {
    fetch('http://localhost:8000/productos') // Change this URL as needed
      .then((response) => response.json())
      .then((data) => {
        let filteredProducts = data.productos;

        // Filter products based on gender from the URL path
  ...
  // Function to format the price in the desired format
